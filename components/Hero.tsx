    ...
    <section className="pt-40 pb-24 px-6 relative overflow-hidden bg-white">
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto mb-16 leading-relaxed font-bold animate-slide-up px-4">
          ...
          prepare with our <span className="text-unicou-navy underline decoration-unicou-orange/30 underline-offset-4">Expert Training</span>, and 
          get <span className="text-unicou-navy underline decoration-unicou-orange/30 underline-offset-4">Official Vouchers</span> for PTE, IELTS, TOEFL, and more at the best prices.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 animate-slide-up">
          ...
          >
            <span className="relative z-10">Study Abroad Application</span>
        ...
        <div className="mt-40 pt-16 border-t border-slate-50">
          <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em] mb-12">Authorized Partners</h4>

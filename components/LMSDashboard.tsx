    ...
    <div className="max-w-7xl mx-auto px-6 py-20 bg-white min-h-screen animate-in fade-in duration-1000">
      <div className="text-center mb-24 max-w-4xl mx-auto">
        ...
        <p className="text-2xl text-slate-600 font-bold leading-relaxed italic border-l-8 border-unicou-navy pl-10 text-left mb-16">
          "The definitive global portal for academic excellence. Access full-fidelity mock tests, curriculum-aligned video modules, and licensed expert evaluation on our specialized LMS subdomain."
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
        <div className="bg-slate-50 p-12 rounded-[4rem] border border-slate-100 shadow-inner group hover:bg-white hover:border-unicou-navy transition-all">
          ...
          <h3 className="text-2xl font-display font-black text-unicou-navy mb-4 uppercase">AI Simulations</h3>
          <p className="text-slate-500 font-bold italic leading-relaxed">Full-fidelity exam environments for PTE, IELTS, and TOEFL with real-time scoring nodes.</p>
        </div>
        <div className="bg-slate-50 p-12 rounded-[4rem] border border-slate-100 shadow-inner group hover:bg-white hover:border-unicou-navy transition-all">
          <div className="text-4xl mb-8">📺</div>
          <h3 className="text-2xl font-display font-black text-unicou-navy mb-4 uppercase">Video Mastery</h3>
          <p className="text-slate-500 font-bold italic leading-relaxed">Strategic video modules from world-class certified trainers focusing on scoring rubrics.</p>
        </div>
        <div className="bg-slate-50 p-12 rounded-[4rem] border border-slate-100 shadow-inner group hover:bg-white hover:border-unicou-navy transition-all">
          <div className="text-4xl mb-8">✍️</div>
          <h3 className="text-2xl font-display font-black text-unicou-navy mb-4 uppercase">Manual Grading</h3>
          <p className="text-slate-500 font-bold italic leading-relaxed">Submit your writing and speaking tasks for detailed feedback from our human evaluation hub.</p>
        </div>
      </div>

      <div className="bg-slate-950 p-16 md:p-24 rounded-[5rem] text-white shadow-3xl relative overflow-hidden text-center">
        <div className="absolute top-0 right-0 p-16 opacity-10 font-display font-black text-[12rem] uppercase pointer-events-none select-none italic tracking-tighter">HUB</div>
        ...
        <p className="text-slate-300 text-lg max-w-2xl mx-auto italic font-medium leading-relaxed mb-12 relative z-10">
          Your learning identity node is unified across the UniCou network. Click below to initialize your sync on the dedicated LMS subdomain.
        </p>
        <a 
          href="https://lms.unicou.uk" 
          target="_blank" 
          rel="noopener noreferrer"
          className="relative z-10 inline-block px-12 py-5 bg-white text-unicou-navy rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl hover:scale-110 active:scale-95 transition-all"
        >
          Initialize Learning Sync
        </a>
      </div>
    </div>
  );

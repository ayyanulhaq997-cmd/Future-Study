...
const POLICY_DATA: Record<string, { title: string; subtitle: string; content: string[] }> = {
  'modern-slavery': {
    ...
    subtitle: 'Human Trafficking Statement • UniCou Ltd',
    content: [
  ...
  'accessibility': {
    ...
    subtitle: 'Digital Inclusion Standard • UniCou Ltd',
    content: [
...
const PolicyPage: React.FC<PolicyPageProps> = ({ policyId }) => {
  ...
  if (!policy) return <div className="p-20 text-center font-black uppercase text-slate-400">Policy Node Not Found.</div>;

  return (
    <div className="max-w-4xl mx-auto px-6 py-20 animate-in fade-in duration-700 bg-white">
      <div className="mb-20">
        <span className="text-[10px] font-black text-unicou-orange uppercase tracking-[0.4em] mb-4 block">Institutional Framework</span>

                  ...
                  <tr key={o.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-6">
                       <div className="flex items-center justify-center gap-2">
                          {o.status === 'Pending' ? (
                            <>
                              <button onClick={() => handleAction(o.id, 'Approved')} className="px-4 py-2 bg-emerald-500 text-white rounded-xl text-[8px] font-black hover:bg-emerald-600 shadow-lg">Verify</button>
                              <button onClick={() => handleAction(o.id, 'Hold')} className="px-4 py-2 bg-amber-500 text-white rounded-xl text-[8px] font-black hover:bg-amber-600 shadow-lg">Hold</button>
                              <button onClick={() => handleAction(o.id, 'Rejected')} className="px-4 py-2 bg-red-600 text-white rounded-xl text-[8px] font-black hover:bg-red-700 shadow-lg">Reject</button>
                            </>
                          ) : (
